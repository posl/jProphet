...
public class JProphetMain {   
    ...
    public static void main(String[] args) {
		// final List<String> sourceFiles = new ArrayList<String>(Arrays.asList("/jacoco_test/src/main/java/jcc/iftest.java"));
		// final List<String> testFiles = new ArrayList<String>(Arrays.asList("/jacoco_test/src/test/java/jcc/AppTest.java"));
		// final List<String> classPaths = new ArrayList<String>(Arrays.asList("/junit-4.11.jar"));
    	// ProjectConfiguration project = new ProjectConfiguration(sourceFiles, testFiles, classPaths);
