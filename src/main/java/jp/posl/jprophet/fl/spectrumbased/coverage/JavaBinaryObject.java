...
public class JavaBinaryObject implements JavaFileObject {
  ...
  private final String originFqn;
   ...
   * @param isTest テストか否か
   */
  public JavaBinaryObject(final String fqn, final String originFqn,
